...
using Consul;
using Fixer.Discovery.Consul.Builders;
using Fixer.Discovery.Consul.Http;
using Fixer.Discovery.Consul.MessageHandlers;
using Fixer.Discovery.Consul.Registries;
using Fixer.HTTP;
